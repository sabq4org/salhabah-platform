# دليل منصة صلهبه التعليمية الشامل
...
| الحقل | القيمة |
|------|--------|
| الاسم الرسمي | ابتدائية صلهبه الأولى وروضة صبيا الثالثة |
| الاسم القصير | منصة صلهبه التعليمية |
...
1. ربط المستودع من Vercel Dashboard (Import → اختيار `salhabah-platform`).
